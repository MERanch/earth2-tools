...
// @match        https://app.earth2.io/#resources
// @grant        none
// @license MIT
// @currentversion	0.1.2 : added UI elements, changed formatting, added "gratitude" lines to csv
// ==/UserScript==
...
setInterval(() => {
    ...
    setInterval(() => {
        ...
        if (lastPageUrl !== window.location.href) {
            ...
            if (window.location.href.includes("resources") && !resourcesInitStarted) {
